...
/**
 * Class for storing often reused regular expression. Feel free to add your (well documented) regex for later reuse.
 *
...
public final class Patterns {
	...
	/**
	 * RegEx for many german words, no leading or trailing spaces are allowed, just between words (many are allowed).
	 */
	...
	/**
	 * A pattern for all strings quoted with single quotes, respectively apostrophe. ' can be masked by prepending \
	 */
	...
	/**
	 * RegEx for an XCRelation Capturing groups: 1 - Captures from first non-WS to comma (excluded)
	 */
	...
	/**
	 * Group for the text of a JSPWiki Link, if it exists. If not, this group contains the link text.
	 */
	...
	/**
	 * A Pattern for jspwiki links. The link text is captured in group 1, the optional page reference in group 2, group
	 * 3 contains optional link attributes. This pattern can handle masked '[' (i.e., '[[', '~[').
	 */

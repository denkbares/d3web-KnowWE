...
@FunctionalInterface
public interface SectionFilter<T extends Type> {
	...
	static <T extends Type> Iterator<Section<T>> filter(Iterator<Section<T>> base, SectionFilter<T> filter) {
	...
	boolean accept(Section<T> section);
}

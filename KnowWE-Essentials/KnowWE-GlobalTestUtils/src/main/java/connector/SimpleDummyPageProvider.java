...
/**
 * This {@link SimpleDummyPageProvider} can be used together with the DummyConnector to provide articles and attachments in a
 * headless or test environment.
 *
 * @author Albrecht Striffler (denkbares GmbH)
 * @created 11.04.2012
 */
public class SimpleDummyPageProvider implements DummyPageProvider{
	private static final Logger LOGGER = LoggerFactory.getLogger(SimpleDummyPageProvider.class);
	...
	public SimpleDummyPageProvider() {
		startupDate = new Date();
	}

	public SimpleDummyPageProvider(ZipFile wikiContentZip) throws IOException {
		this();
	...
	public SimpleDummyPageProvider(File wikiContent) throws IOException {
		this();
	...
	public void setArticleContent(String title, String content, String changeNote) {
		if(!changeNote.isBlank()) {
			throw new NotImplementedException("Does not support changenotes");
		} else {

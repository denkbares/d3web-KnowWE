...
<div id="actionsTop" class="pageactions">
	<ul>
				...
				<li>
					...
					<wiki:PageType type="attachment">
						<a href="<wiki:BaseURL/>Edit.jsp?page=<wiki:ParentPageName />" accesskey="e" class="action edit"
						   title="<fmt:message key='actions.editparent.title'/>"><fmt:message
								key='actions.editparent'/></a>
					</wiki:PageType>
				</li>
			</wiki:Permission>
		...
		<%--Disabled click on MoreMenu--%>
		<li id="morebutton">
			<a class="action more"><fmt:message key="actions.more"/></a>
		</li>

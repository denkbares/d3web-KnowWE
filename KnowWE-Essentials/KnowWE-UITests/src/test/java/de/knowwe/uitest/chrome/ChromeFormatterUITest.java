...
import de.knowwe.uitest.KnowWEUITest;
 ...
 */
public abstract class ChromeFormatterUITest extends KnowWEUITest {
	...
	public static void setUp() throws Exception {
		driver = UITestUtils.setUp(devMode, DesiredCapabilities.chrome(), ChromeFormatterUITest.class.getSimpleName());
	}

...
public class CIDashboardManager {
	...
	public static Set<CIDashboard> getAllDashboards(ArticleManager manager) {
		return Collections.unmodifiableSet(CIDashboardManager.getDashboardsMap(manager).valueSet());
	}

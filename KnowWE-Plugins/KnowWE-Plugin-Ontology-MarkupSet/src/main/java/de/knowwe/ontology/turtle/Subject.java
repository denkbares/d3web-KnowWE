...
public class Subject extends AbstractType implements ResourceProvider<Subject> {
	...
	@SuppressWarnings({
			"rawtypes", "unchecked" })
	public Value getNode(OntologyCompiler compiler, Section<? extends Subject> section) {
		...
		if (nodeProviderChild != null) {
			return nodeProviderChild.get().getNode(compiler, nodeProviderChild);
		}
		return null;
	}

	@Override
	public Resource getResource(OntologyCompiler core, Section<? extends Subject> section) {

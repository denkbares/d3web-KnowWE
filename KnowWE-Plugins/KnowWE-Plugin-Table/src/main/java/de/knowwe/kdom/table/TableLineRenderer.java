...
public class TableLineRenderer implements Renderer {
	...
	public void render(Section<?> sec, UserContext user, RenderResult string) {
		...
		renderLineEnding(sec, user, string);
	...
	@SuppressWarnings("unused") // suppressed since unused parameters might be used in child classes
	protected void renderLineEnding(Section<?> sec, UserContext user, RenderResult string) {
		string.appendHtml("</tr>\n");
	}

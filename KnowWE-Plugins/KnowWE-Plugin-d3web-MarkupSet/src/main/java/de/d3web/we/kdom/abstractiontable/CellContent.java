...
public class CellContent extends AbstractType implements D3webTerm<NamedObject>, RenamableTerm {
	...
	private class MessagesScript implements D3webCompileScript<CellContent> {
		...
		private void setCellType(D3webCompiler compiler, Section<CellContent> section) throws CompilerMessage {
	...
	private class CellRenderer implements Renderer {
		...
		public void render(Section<?> section, UserContext user, RenderResult result) {
			...
			D3webCompiler compiler = D3webUtils.getCompiler(section);
			CellType type = CellContent.this.getType(compiler, Sections.cast(section, CellContent.class));
			if (compiler != null) {
				if (type == CellType.QUESTION_REFERENCE) {

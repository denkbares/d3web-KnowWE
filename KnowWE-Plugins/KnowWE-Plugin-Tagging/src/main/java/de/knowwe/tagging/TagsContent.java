...
public class TagsContent extends XMLContent {
	 ...
	 * @author Alex Legler
	 */
	private static class TagsContentSubtreeHandler extends DefaultGlobalScript<TagsContent> {

		@Override
		public void compile(DefaultGlobalCompiler compiler, Section<TagsContent> section) {
			TaggingMangler.getInstance().registerTags(section.getTitle(), section.getText());
		}
	}
}
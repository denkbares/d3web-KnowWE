...
public abstract class ServerInterceptor extends HandlerInterceptorAdapter {
	 ...
	 * @throws ClientHTTPException if it was impossible to set one or more attributes due to a bad
	 *                             request on the part of the client
	 * @throws ServerHTTPException if it was impossible to set one or more attributes due to an
	 *                             internal error
	 */
	 ...
	 *
	 * @throws ServerHTTPException if some resources could not be cleaned up because of an internal
	 *                             error
	 */

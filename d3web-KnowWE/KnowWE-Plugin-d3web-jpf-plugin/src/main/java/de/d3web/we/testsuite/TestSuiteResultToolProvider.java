...
/**
 * ToolProvider which provides some download links for the TestSuiteResultType.
 * 
 * @author Sebastian Furth (denkbares GmbH)
 * @created 25/10/2010
 */
public class TestSuiteResultToolProvider implements ToolProvider {

	@Override
	public Tool[] getTools(KnowWEArticle article, Section<?> section, KnowWEUserContext userContext) {
		String topic = TestSuiteResultType.getTestSuite(section);
	...
	protected Tool getDownloadPDFTool(String topic, String web, String id) {
		...
		String jsAction = "window.location='action/TestSuiteServlet?type=visualization&KWiki_Topic="

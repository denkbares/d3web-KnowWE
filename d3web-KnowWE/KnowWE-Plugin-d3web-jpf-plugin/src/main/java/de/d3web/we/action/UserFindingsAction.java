...
public class UserFindingsAction extends DeprecatedAbstractKnowWEAction {
	...
	public String perform(KnowWEParameterMap map) {
		...
		for (Information information : userInfos) {
			...
			String[] content = {
					getObjectText(information, map),
					"=",
					getValueText(information, map),
					getJumpLink(information.getNamespace(), information.getObjectID(),
							information.getNamespace(), userString, web) };

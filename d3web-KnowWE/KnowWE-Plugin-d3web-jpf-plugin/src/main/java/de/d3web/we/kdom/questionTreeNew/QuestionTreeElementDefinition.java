...
//
// public abstract class QuestionTreeElementDefinition<TermObject> extends
// D3webTermDefinition<TermObject> {
//
...
// public Section<? extends QuestionTreeElementDefinition<?>>
// retrieveAndStoreParentQASetSection(
// Section<? extends QuestionTreeElementDefinition<?>> s) {
//
// Section<DashSubtree> subTree = DashTreeUtils.getDashSubtreeFather(s);
...
// */
// @SuppressWarnings("unchecked")
// public final Section<? extends QuestionTreeElementDefinition<?>>
// getStoredParentQASetSection(
...
// @SuppressWarnings("unchecked")
// public final Section<? extends QuestionTreeElementDefinition<?>>
// getLastStoredQASetSection(
// Section<? extends QuestionTreeElementDefinition<?>> s) {
//
// return (Section<? extends QuestionTreeElementDefinition<?>>)
// KnowWEUtils.getObjectFromLastVersion(
// s.getArticle(), s, parentQASetSectionKey);
// }
//
// // public static abstract class QuestionTreeElementDefSubtreeHandler<T
// // extends QuestionTreeElementDefinition<?>>

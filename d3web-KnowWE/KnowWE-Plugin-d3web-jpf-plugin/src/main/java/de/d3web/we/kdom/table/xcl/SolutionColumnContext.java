 ...
 * @author jochen
 * 
 *         A context allowing a cell to easily access the column attributes
 *         (solution) (which cannot easily be provided be the KDOM structure
 *         itself, because tables are split by lines)
 * 
 */

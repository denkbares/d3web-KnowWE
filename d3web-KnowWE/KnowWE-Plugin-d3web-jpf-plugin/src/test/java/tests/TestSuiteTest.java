...
/**
 * This class tests whether the 
 * TestSuites are equal
 * 
...
public class TestSuiteTest extends TestCase {
	 ...
	 * NOTE: derived Solutions are not tested because they 
	 *       have nothing to do with the creation/ parsing
	 *       of the the TestSuite(-section)
	 */

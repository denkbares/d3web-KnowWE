...
public class XCLTest extends TestCase {
	...
	public void testXCLModels() {
		...
		Collection<KnowledgeSlice> createdXCLModels = createdKB.getAllKnowledgeSlicesFor(
				PSMethodXCL.class, XCLModel.XCLMODEL);
		...
		if (loadedXCLModel != null && createdXCLModel != null) {
			...
			assertEquals("Contradicting Relation is wrong.",
					createdRelation.getConditionedFinding(), loadedRelation.getConditionedFinding());
			...
			assertEquals("Necessary Relation is wrong.", createdRelation.getConditionedFinding(),
			...
			assertEquals("Sufficient Relation is wrong.", createdRelation.getConditionedFinding(),
					loadedRelation.getConditionedFinding());

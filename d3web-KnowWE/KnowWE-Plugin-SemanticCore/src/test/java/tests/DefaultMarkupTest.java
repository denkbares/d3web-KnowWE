...
public class DefaultMarkupTest {
	...
	/**
	 * Tests, if a mandatory annotation which was left out in the markup
	 * gets detected. 
	 */
	@Test
	...
	/**
	 * Within the content block, a at-sign ("@") is only allowed if a non-whitespace-character
	 * stands directly in front of it or if it is not directly followed by a word-character. 
	 * Therefore, The start of the first annotation is matched by:
	 * "at least one whitespace-char" followed by "@" followed by "at least one word-character"
	 */
	@Test
	public void testAtSignInContent() {
		...
		String text = "Das ist ein Wiki-Artikel\r\n"+
		 			...
		 			"%%TestMarkup\r\n"+
		 				...
		 				"@\r\n"+//@ in a single line
		 				"oder 1404@anno1.de\r\n"+//@ in content with "type" of an annotation
		 				"some Text @anno1=BLUBB\r\n"+//rest of content and beginning of
	...
	/**
	 * Tests, if a multiple-line-block can be terminated by "%"
	 * (in a single line).
	 */
	@Test
	...
	public void testAlternativeBlockTermination(){
		String text = "Erstmal ein bißchen Inhalt!\r\n"+
					...
					"Das ist der Content-Block.\r\n"+
					"@anno1:Diese Annotation muss noch enthalten sein!\r\n"+
					"/%\r\n"+//Alternative termination of Default Markup Block
					"@anno2:anno2value1\r\n"+//This is just plain-text!
					"Dieser Text darf nichtmehr im Content stehen!\r\n"+
					"%";

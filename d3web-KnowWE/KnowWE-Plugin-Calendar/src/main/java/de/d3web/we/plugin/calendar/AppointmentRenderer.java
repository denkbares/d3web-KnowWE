...
public class AppointmentRenderer extends KnowWEDomRenderer{
	...
	public void render(Section sec, KnowWEUserContext user, StringBuilder string) {
		...
		Section dateSec = sec.findChildOfType(AppointmentStartSymbol.class).findChildOfType(AppointmentDate.class);
		Section timeSec = sec.findChildOfType(AppointmentStartSymbol.class).findChildOfType(AppointmentTime.class);

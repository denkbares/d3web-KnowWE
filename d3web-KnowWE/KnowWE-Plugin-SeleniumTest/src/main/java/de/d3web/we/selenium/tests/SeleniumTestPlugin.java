 ...
 * @author Alex Legler
 */
public class SeleniumTestPlugin extends AbstractDefaultKnowWEModule {
	
	
	/**
	 * Singleton instance
	 */
	private static SeleniumTestPlugin instance;
	 ...
	 * @return
	 */
	public static SeleniumTestPlugin getInstance() {
		if (instance == null)
			instance = new SeleniumTestPlugin();

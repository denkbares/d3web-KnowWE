...
function olcmdext1() {
 return overlib(OLresponseAJAX, TEXTPADDING,0, CAPTIONPADDING,4,
  ...
  WRAP, BORDER,2, STICKY, CLOSECLICK, 
  MIDX,0, RELY,100,
  STATUS,'Example with AJAX content via responseText of XMLHttpResponse');
}

function kajaxwrapper(title) {
 return overlib(OLresponseAJAX, CAPTION,title, WRAP,CLOSECLICK, STATUS,title,STICKY,MOUSEOFF,NOCLOSE);
}

...
public class ComposedNodeHandler extends AbstractNodeHandler {
	...
	public INode createNode(KnowWEArticle article, KnowledgeBaseManagement kbm,
		...
		// QContainer container = kbm.findQContainer(flowName +
		// "_Questionnaire");
		//
		// if (container == null) {
		...
		// flowName + "_" +
		// FlowchartTerminologySubTreeHandler.STARTNODES_QUESTION_NAME))
		...
		// FlowFactory.getInstance().createSetValueAction();
		//

...
public class DecisionTree_BasicParser extends Parser {
	...
	// delegates
	// delegators
	public DecisionTree gDecisionTree;
	public DecisionTree gParent;

	public DecisionTree_BasicParser(TokenStream input, DecisionTree gDecisionTree) {
		this(input, new RecognizerSharedState(), gDecisionTree);
	}

	public DecisionTree_BasicParser(TokenStream input, RecognizerSharedState state, DecisionTree gDecisionTree) {
		super(input, state);
		this.gDecisionTree = gDecisionTree;

		gParent = gDecisionTree;
	}
	...
	public final DecisionTree_BasicParser.name_return name() throws RecognitionException {
		...
		try {
			...
			if ((LA3_0 == String)) {
				...
				if ((LA3_1 == EOF || LA3_1 == DD || LA3_1 == SEMI || (LA3_1 >= AT && LA3_1 <= SBC)
						|| LA3_1 == NL || (LA3_1 >= DEFAULT && LA3_1 <= INIT) || LA3_1 == SET)) {
					alt3 = 2;
				}
	...
	public final DecisionTree_BasicParser.nameOrDouble_return nameOrDouble() throws RecognitionException {
		...
		DecisionTree_BasicParser.d3double_return d3double2 = null;

		DecisionTree_BasicParser.name_return name3 = null;

...
// $ANTLR 3.1.1 BasicParser.g 2009-10-14 10:35:20
...
public class DashTree_BasicParser extends Parser {
	...
	// delegates
	// delegators
	public DashTree gDashTree;
	public DashTree gParent;

	public DashTree_BasicParser(TokenStream input, DashTree gDashTree) {
		this(input, new RecognizerSharedState(), gDashTree);
	}

	public DashTree_BasicParser(TokenStream input, RecognizerSharedState state, DashTree gDashTree) {
		super(input, state);
		this.gDashTree = gDashTree;
	...
	public final DashTree_BasicParser.name_return name() throws RecognitionException {
		DashTree_BasicParser.name_return retval = new DashTree_BasicParser.name_return();
		...
		try {
			...
			if ((LA3_0 == String)) {
				...
				else if ((LA3_1 == EOF || LA3_1 == DD || LA3_1 == ORS || LA3_1 == TILDE
						|| LA3_1 == RP || (LA3_1 >= SBO && LA3_1 <= SBC) || LA3_1 == NL)) {
					alt3 = 2;
				}
				else {
	...
	// COMMA | DOT ) INT )? ;
	public final DashTree_BasicParser.d3double_return d3double() throws RecognitionException {
		DashTree_BasicParser.d3double_return retval = new DashTree_BasicParser.d3double_return();
		retval.start = input.LT(1);
	...
	public final DashTree_BasicParser.nameOrDouble_return nameOrDouble() throws RecognitionException {
		DashTree_BasicParser.nameOrDouble_return retval = new DashTree_BasicParser.nameOrDouble_return();
		retval.start = input.LT(1);

		DashTree_BasicParser.d3double_return d3double2 = null;

		DashTree_BasicParser.name_return name3 = null;

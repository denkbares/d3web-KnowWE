...
// SVN\\d3web-KnowWE\\d3web-KnOfficeParser\\src\\main\\antlr\\DefaultLexer.g
// 2009-10-14 10:09:28
...
public class DefaultLexer extends Lexer {
	...
	public String getGrammarFileName() {
		return "D:\\eclipse workspaces\\Uni SVN\\d3web-KnowWE\\d3web-KnOfficeParser\\src\\main\\antlr\\DefaultLexer.g";
	}
	...
	public final void mBLUB() throws RecognitionException {
		try {
			...
			// SVN\\d3web-KnowWE\\d3web-KnOfficeParser\\src\\main\\antlr\\DefaultLexer.g:57:5:
			// ()
			// D:\\eclipse workspaces\\Uni
			// SVN\\d3web-KnowWE\\d3web-KnOfficeParser\\src\\main\\antlr\\DefaultLexer.g:57:6:
			{
			}
	...
	public void mTokens() throws RecognitionException {
		// D:\\eclipse workspaces\\Uni
		// SVN\\d3web-KnowWE\\d3web-KnOfficeParser\\src\\main\\antlr\\DefaultLexer.g:1:8:
		// ( BLUB | BasicLexer. Tokens )
		int alt1 = 2;
		int LA1_0 = input.LA(1);

		if (((LA1_0 >= '\t' && LA1_0 <= '\n') || LA1_0 == '\r' || (LA1_0 >= ' ' && LA1_0 <= '[')
				|| LA1_0 == ']' || LA1_0 == '_' || (LA1_0 >= 'a' && LA1_0 <= '~') || (LA1_0 >= '\u00A1' && LA1_0 <= '\uEFFF'))) {
			alt1 = 2;
		}
		else {
			alt1 = 1;
		...
		case 1:
			// D:\\eclipse workspaces\\Uni
			// SVN\\d3web-KnowWE\\d3web-KnOfficeParser\\src\\main\\antlr\\DefaultLexer.g:1:10:
			// BLUB
		{
			mBLUB();
		...
		case 2:
			// D:\\eclipse workspaces\\Uni
			// SVN\\d3web-KnowWE\\d3web-KnOfficeParser\\src\\main\\antlr\\DefaultLexer.g:1:15:
			// BasicLexer. Tokens
		{
			gBasicLexer.mTokens();

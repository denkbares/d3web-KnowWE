...
public class XCL_ComplexCondition_BasicParser extends Parser {
	...
	public XCL_ComplexCondition gParent;

	public XCL_ComplexCondition_BasicParser(TokenStream input, XCL gXCL, XCL_ComplexCondition gComplexCondition) {
		this(input, new RecognizerSharedState(), gXCL, gComplexCondition);
	}

	public XCL_ComplexCondition_BasicParser(TokenStream input, RecognizerSharedState state, XCL gXCL, XCL_ComplexCondition gComplexCondition) {
		super(input, state);
		this.gXCL = gXCL;
	...
	public final XCL_ComplexCondition_BasicParser.name_return name() throws RecognitionException {
		...
		try {
			...
			if ((LA3_0 == String)) {
				...
				if (((LA3_1 >= COMMA && LA3_1 <= SEMI) || LA3_1 == ORS
						|| (LA3_1 >= RP && LA3_1 <= EQ) || (LA3_1 >= AND && LA3_1 <= OR)
						|| LA3_1 == IN || LA3_1 == ALL)) {
					alt3 = 2;
				}
				...
				if ((LA6_0 == COMMA)) {
					...
					if ((LA6_1 == INT)) {
						...
						case INT: {
							...
							if ((LA6_5 == DOT || LA6_5 == COMMA || LA6_5 == SBC)) {
								alt6 = 1;
							}
						}
							break;
	...
	public final XCL_ComplexCondition_BasicParser.nameOrDouble_return nameOrDouble() throws RecognitionException {
		...
		XCL_ComplexCondition_BasicParser.d3double_return d3double3 = null;

		XCL_ComplexCondition_BasicParser.name_return name4 = null;

...
// $ANTLR 3.1.1 ComplexCondition.g 2010-02-22 09:40:13
...
public class Complexrules_ComplexCondition extends Parser {
	...
	public Complexrules_ComplexCondition(TokenStream input, RecognizerSharedState state, Complexrules gComplexrules) {
		...
		gBasicParser = new Complexrules_ComplexCondition_BasicParser(input, state, gComplexrules,
				this);
	...
	public final Complexrules_ComplexCondition.condition_return condition() throws RecognitionException {
		...
		Complexrules_ComplexCondition_BasicParser.nameOrDouble_return nod2 = null;
					...
					// nod2= nameOrDouble )*
				{
					...
					loop7: do {
							...
							// ComplexCondition.g:74:130: ORS nod2= nameOrDouble
						{
							...
							nod2 = gComplexrules.nameOrDouble();

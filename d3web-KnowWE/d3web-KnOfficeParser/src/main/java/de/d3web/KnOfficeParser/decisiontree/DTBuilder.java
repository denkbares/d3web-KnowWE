...
/**
 * Dieses Interface muss implementiert werden, um die Klasse dem
 * Entscheidungsbaumparser mitzugeben und somit den Output zu erzeugen
 * 
...
public interface DTBuilder {
	...
	void addQuestionclass(String name, String ref, int line, String linetext, List<String> attributes, List<String> values);

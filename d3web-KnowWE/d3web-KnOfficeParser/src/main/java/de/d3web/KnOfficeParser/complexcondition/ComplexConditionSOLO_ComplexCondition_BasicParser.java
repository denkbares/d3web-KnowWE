// $ANTLR 3.2 Sep 23, 2009 12:02:23 BasicParser.g 2009-10-13 18:05:23
    ...
    public final ComplexConditionSOLO_ComplexCondition_BasicParser.name_return name() throws RecognitionException {
        ...
        try {
            ...
            if ( (LA3_0==String) ) {
                ...
                if ( (LA3_1==EOF||(LA3_1>=COMMA && LA3_1<=SEMI)||LA3_1==RP||(LA3_1>=CBC && LA3_1<=EQ)||(LA3_1>=AND && LA3_1<=OR)||LA3_1==IN||LA3_1==ALL) ) {
                    alt3=2;
                }

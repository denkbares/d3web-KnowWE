...
public class Complexrules_ComplexCondition_BasicParser extends Parser {
	...
	public Complexrules_ComplexCondition gParent;

	public Complexrules_ComplexCondition_BasicParser(TokenStream input, Complexrules gComplexrules, Complexrules_ComplexCondition gComplexCondition) {
		this(input, new RecognizerSharedState(), gComplexrules, gComplexCondition);
	}

	public Complexrules_ComplexCondition_BasicParser(TokenStream input, RecognizerSharedState state, Complexrules gComplexrules, Complexrules_ComplexCondition gComplexCondition) {
		super(input, state);
	...
	public final Complexrules_ComplexCondition_BasicParser.name_return name() throws RecognitionException {
		Complexrules_ComplexCondition_BasicParser.name_return retval = new Complexrules_ComplexCondition_BasicParser.name_return();
		...
		try {
			...
			if ((LA3_0 == String)) {
				...
				else if ((LA3_1 == EOF || (LA3_1 >= COMMA && LA3_1 <= SEMI) || LA3_1 == ORS
						|| LA3_1 == RP || (LA3_1 >= CBC && LA3_1 <= DIV)
						|| (LA3_1 >= NL && LA3_1 <= OR) || LA3_1 == EXCEPT || LA3_1 == IN || LA3_1 == ALL)) {
					alt3 = 2;
				}
				else {
				...
				// String )*
			{
				...
				loop1: do {
					...
					case 1:
						// BasicParser.g:63:3: String
					{
						match(input, String, FOLLOW_String_in_name38);
			...
			{
				String1 = (Token) match(input, String, FOLLOW_String_in_name60);
				if (state.failed) return retval;
				if (state.backtracking == 0) {
	...
	public final String type() throws RecognitionException {
		...
		try {
			...
			{
				match(input, SBO, FOLLOW_SBO_in_type74);
				if (state.failed) return value;
				ID2 = (Token) match(input, ID, FOLLOW_ID_in_type76);
				if (state.failed) return value;
				match(input, SBC, FOLLOW_SBC_in_type78);
				if (state.failed) return value;
				if (state.backtracking == 0) {
	...
	public final Complexrules_ComplexCondition_BasicParser.eq_return eq() throws RecognitionException {
		Complexrules_ComplexCondition_BasicParser.eq_return retval = new Complexrules_ComplexCondition_BasicParser.eq_return();
		retval.start = input.LT(1);
	...
	public final Complexrules_ComplexCondition_BasicParser.eqncalc_return eqncalc() throws RecognitionException {
		Complexrules_ComplexCondition_BasicParser.eqncalc_return retval = new Complexrules_ComplexCondition_BasicParser.eqncalc_return();
		retval.start = input.LT(1);
		...
		try {
			...
			{
				match(input, PLUS, FOLLOW_PLUS_in_eqncalc106);
				if (state.failed) return retval;
				match(input, EQ, FOLLOW_EQ_in_eqncalc108);
				if (state.failed) return retval;
			...
			{
				match(input, MINUS, FOLLOW_MINUS_in_eqncalc110);
				if (state.failed) return retval;
				match(input, EQ, FOLLOW_EQ_in_eqncalc112);
				if (state.failed) return retval;
	...
	// COMMA | DOT ) INT )? ;
	public final Complexrules_ComplexCondition_BasicParser.d3double_return d3double() throws RecognitionException {
		Complexrules_ComplexCondition_BasicParser.d3double_return retval = new Complexrules_ComplexCondition_BasicParser.d3double_return();
		retval.start = input.LT(1);
		...
		try {
			...
			// BasicParser.g:73:3: ( MINUS )? INT ( ( COMMA | DOT ) INT )?
			{
				...
				case 1:
					// BasicParser.g:73:3: MINUS
				{
					match(input, MINUS, FOLLOW_MINUS_in_d3double124);
					if (state.failed) return retval;
				...
				match(input, INT, FOLLOW_INT_in_d3double127);
				if (state.failed) return retval;
					...
					// BasicParser.g:73:15: ( COMMA | DOT ) INT
				{
					...
					match(input, INT, FOLLOW_INT_in_d3double136);
					if (state.failed) return retval;
	...
	public final Complexrules_ComplexCondition_BasicParser.nameOrDouble_return nameOrDouble() throws RecognitionException {
		Complexrules_ComplexCondition_BasicParser.nameOrDouble_return retval = new Complexrules_ComplexCondition_BasicParser.nameOrDouble_return();
		retval.start = input.LT(1);

		Complexrules_ComplexCondition_BasicParser.d3double_return d3double3 = null;

		Complexrules_ComplexCondition_BasicParser.name_return name4 = null;
		...
		try {
			...
			{
				match(input, EX, FOLLOW_EX_in_nameOrDouble181);
				if (state.failed) return retval;
				if (state.backtracking == 0) {
					retval.value = input.toString(retval.start, input.LT(-1));
				}

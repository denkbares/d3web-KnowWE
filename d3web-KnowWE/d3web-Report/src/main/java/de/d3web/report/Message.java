...
/**
 * Stores messages from the parsers. Used to indicate errors during parsing.
 * Therefore a message stores the actual message, the filename, line number and
 * the erroneous line with error the error highlighted.
 * 
...
public class Message {
	...
	/**
	 * Constructor. Creates a message with given message text and name of the
	...
	/**
	 * Constructor. Creates a message with message text, filename and line
	...
	/**
	 * Constructor. Creates a message with message text, filename and line of
	 * the message.
	 * 
	 * @param messageText
	 * @param file
	...
	/**
	 * Constructor. Creates a message with message text, filename, line number
	 * and line of the message.
	 * 
	 * @param messageText
	 * @param file
	 * @param lineNo
	...
	public void setMessageType(String messageType) {
		if ((messageType == null) ||
				!(messageType == ERROR || messageType == WARNING || messageType == NOTE)) this.messageType = UNKNOWN_ERROR;
		else this.messageType = messageType;
	}
	...
	public String toString() {
		...
		if (messageType == ERROR || messageType == WARNING || messageType == NOTE) s += messageType
				+ ": ";
		s += messageText + "\n";

...
public class DPSEnvironmentManager {
	...
	// Logger.getLogger(getClass().getName()).warning("Error: initialization failed: "
	// + webDirString);
	// }
	// }
	// return result;
		...
		if (result == null) {
			...
			try {
				...
				Logger.getLogger(getClass().getName()).warning(
						"Error: initialization failed: " + webDirString);
			}
		}
		return result;
	}
	...
	public DPSEnvironment createEnvironment(String webID) {
		...
		try {
			...
			Logger.getLogger(getClass().getName()).warning(
					"Error: Cannot initialize: " + webEnvironmentLocation + webID + " :\n "
							+ e.getMessage());
		}
		return result;
	}

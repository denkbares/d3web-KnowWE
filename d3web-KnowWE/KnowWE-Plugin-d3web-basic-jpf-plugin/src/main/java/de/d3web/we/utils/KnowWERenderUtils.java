...
public class KnowWERenderUtils {
	...
	public static StringBuffer getKopicLinks(String web, Term term, String iconURL, String usagePrefix, boolean withTitle, boolean asButton) {
		...
		List<IdentifiableInstance> iis = dpse.getTerminologyServer().getBroker().getAlignedIdentifiableInstances(
				term, TerminologyAlignmentLinkFilter.getInstance());
		iis = getOnlyIIOs(iis);
		...
		if (iis == null || iis.isEmpty()) {
			...
			sb.append("<div KWikiPopupLinksDiv=\"KWikiPopupLinksDiv\" id='"
					+ exactPrefix
					+ "kopicLinks' class='patternToolBar' style='position:absolute;top:16px;right:0px;visibility:hidden;overflow:visible;'>");
			sb.append("<table>");
			...
			for (IdentifiableInstance eachII : iis) {
				...
				sb.append("<tr>");
				sb.append("<td>");
				sb.append("<div class='patternButton' style='clear:left; text-align:left; width:100%; overflow:visible;'><a href='"
						+ getLinkToKopic(eachII, web)
						+ "' rel='nofollow' title='"
						+ rb.getString("KnowWE.topic.defining.show")
						+ "'>"
						+ eachII.getNamespace().split("\\.\\.")[0] + "</a></div>");
				sb.append("</td>");
				sb.append("</tr>");
	...
	public static StringBuffer getDialogLinks(String user, String web, Term term, String iconURL, String usagePrefix, boolean withTitle, boolean asButton) {
		...
		if (iis == null || iis.isEmpty()) {
			...
			sb.append("<a href='javascript:doNothing()' onClick=\"showDialogLinks('" + exactPrefix
					+ "', event)\">");
			sb.append("<img border='0' style='margin-left:1px;margin-right:1px' src=\"");
			sb.append(iconURL);
			sb.append("windowIcon.gif");
			...
			sb.append("<div KWikiPopupLinksDiv=\"KWikiPopupLinksDiv\" id='"
					+ exactPrefix
					+ "dialogLinks' class='patternToolBar' style='position:absolute;top:16px;right:0px;visibility:hidden;overflow:visible;'>");
			sb.append("<table>");
			for (IdentifiableInstance eachII : iis) {
				sb.append("<tr>");
				sb.append("<td>");
				sb.append("<div class='patternButton' style='clear:left; text-align:left; width:100%; overflow:visible;'><a href='"
						+ getLinkToDialog(eachII, user, web)
						+ "' target='"
						+ KnowWEAttributes.KNOWWE_DIALOG
						+ "' rel='nofollow' title='"
						+ rb.getString("KnowWE.dialog.show")
						+ "'>"
						+ eachII.getNamespace()
						+ "</a></div>");
				sb.append("</td>");
	...
	public static StringBuffer getExplanationLinks(String user, String web, Term term, String iconURL, String usagePrefix, boolean withTitle, boolean asButton) {
		...
		if (iis == null || iis.isEmpty()) {
			...
			sb.append("<a href='javascript:doNothing()' onClick=\"showExplanationLinks('"
					+ exactPrefix + "', event)\">");
			sb.append("<img border='0' style='margin-left:1px;margin-right:1px' src=\"");
			sb.append(iconURL);
			sb.append("comments.png");
			...
			sb.append("<div KWikiPopupLinksDiv=\"KWikiPopupLinksDiv\" id='"
					+ exactPrefix
					+ "explanationLinks' class='patternToolBar' style='position:absolute;top:16px;right:0px;visibility:hidden;overflow:visible;'>");
			sb.append("<table>");
			for (IdentifiableInstance eachII : iis) {
				sb.append("<tr>");
				sb.append("<td>");
				sb.append("<div class='patternButton' style='clear:left; text-align:left; width:100%; overflow:visible;'><a href='"
						+ getLinkToExplanation(eachII, user, web)
						+ "' target='"
						+ KnowWEAttributes.KNOWWE_DIALOG
						+ "' rel='nofollow' title='"
						+ rb.getString("KnowWE.explanation.show")
						+ "'>"
						+ eachII.getNamespace()
						+ "</a></div>");
				sb.append("</td>");
	...
	public static StringBuffer getClarificationLinks(String user, String web, Term term, String iconURL, String usagePrefix, boolean withTitle, boolean asButton) {
		...
		if (iis == null || iis.isEmpty()) {
			...
			sb.append("<a href='javascript:doNothing()' onClick=\"showClarificationLinks('"
					+ exactPrefix + "', event)\">");
			sb.append("<img border='0' style='margin-left:1px;margin-right:1px' src=\"");
			sb.append(iconURL);
			sb.append("comments.png");
			...
			sb.append("<div KWikiPopupLinksDiv=\"KWikiPopupLinksDiv\" id='"
					+ exactPrefix
					+ "clarificationLinks' class='patternToolBar' style='position:absolute;top:16px;right:0px;visibility:hidden;overflow:visible;'>");
			sb.append("<table>");
			for (IdentifiableInstance eachII : iis) {
				sb.append("<tr>");
				sb.append("<td>");
				sb.append("<div class='patternButton' style='clear:left; text-align:left; width:100%; overflow:visible;'><a href='"
						+ getLinkToClarification(eachII, user, web)
						+ "' target='"
						+ KnowWEAttributes.KNOWWE_DIALOG
						+ "' rel='nofollow' title='"
						+ rb.getString("KnowWE.clarification.show")
						+ "'>"
						+ eachII.getNamespace()
						+ "</a></div>");
				sb.append("</td>");
...
class TerminologyAlignmentLinkFilter implements AlignmentFilter {

 ...
 * parameters have to be specified. They are called by the edit-renderer to
 * renderer the edit component of the cells (textfield, dropdown-options...)
 * 
...
public interface TableAttributesProvider {
	...
	/**
	 * * comma separated list of row numbers, which should be NOT editable (for
	 * header-rows) in quick-edit
	 * 
	 * @param s
	 * @return
	 */
	...
	/**
	 * comma separated list of column numbers, which should be NOT editable (for
	 * header-columns) in quick-edit
	 * 
	 * @param s
	 * @return
	 */

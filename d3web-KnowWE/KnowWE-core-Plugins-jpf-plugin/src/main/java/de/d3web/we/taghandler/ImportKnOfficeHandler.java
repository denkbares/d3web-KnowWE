...
public class ImportKnOfficeHandler extends AbstractHTMLTagHandler {
	...
	public String renderHTML(String topic, KnowWEUserContext user, Map<String, String> values, String web) {
		...
		Object[][] fields = {
				{
						"KnowWE.knoffice.fields.wikipage", KEY_WIKIPAGE, "text", 50, "" },
				{
						"KnowWE.knoffice.fields.diagnosishierachy", KEY_SOLUTIONS, "file", 50,
						"txt" },
				{
						"KnowWE.knoffice.fields.questionclasshierachy", KEY_QUESTIONNAIRES, "file",
						50, "txt" },
				{
				...
				{
						"KnowWE.knoffice.fields.setCoveringList", KEY_COVERINGLISTS, "file", 50,
						"txt" },
				{
						"KnowWE.knoffice.fields.setCoveringTable", KEY_COVERINGTABLE, "file", 50,
						"xls" },
				{
						"KnowWE.knoffice.fields.diagnosticScores", KEY_SCORETABLE, "file", 50,
						"xls" },
				{
						"KnowWE.knoffice.fields.decisionTable", KEY_DECISIONTABLE, "file", 50,
						"xls" },
				{
		...
		Object[][] extFields = {
				{
						"KnowWE.knoffice.fields.dialog.settings", KEY_DIALOG_SETTINGS, "file", 50,
						"xml", "dialogsettings.xml" },
				{
						"KnowWE.knoffice.fields.dialog.layout", KEY_DIALOG_LAYOUT, "file", 50,
						"xml", "dialoglayout.xml" },
				{
						"KnowWE.knoffice.fields.dialog.sheet", KEY_DIALOG_CSS, "file", 50, "css",
						"dialog.css" },
				{

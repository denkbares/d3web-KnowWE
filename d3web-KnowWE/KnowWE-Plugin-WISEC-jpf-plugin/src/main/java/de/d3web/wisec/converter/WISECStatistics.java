...
public class WISECStatistics {
	...
	// how many substances were considered for knowledge generation in the specified substance list (id per name)
	public Map<String, Integer> substanceListConsideredSubstances = new HashMap<String, Integer>();
	// how many substances were NOT considered for knowledge generation in the specified substance list (id per name)
	public Map<String, Integer> substanceListNotConsideredSubstances = new HashMap<String, Integer>();
	// Consider only substances for knowledge generation, that occur in the lists more than the specified threshold  

...
public class ValidationPageAppendHandler implements PageAppendHandler {
	...
	private static ValidationPageAppendHandler instance;
	
	public static ValidationPageAppendHandler getInstance() {
		if (instance == null) {
			instance = new ValidationPageAppendHandler();
		}
		return instance;
	}
	
	private ValidationPageAppendHandler() {};

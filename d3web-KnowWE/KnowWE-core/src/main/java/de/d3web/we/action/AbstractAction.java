...
/**
 * Abstract superclass for Actions (KnowWEActions or Servlets) with standard
 * implementations for most methods.
 * 
 * The ActionContext of the execute method provides you everything you need for
 * your Actions. If you want to have some textual output just use

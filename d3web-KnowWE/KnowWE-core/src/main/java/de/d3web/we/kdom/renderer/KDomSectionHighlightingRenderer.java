 ...
 * it to enable highlighting. It Uses the SpecialDelegateRender.
 * 
 * Note: If you need more functionality then just highlighting a section. For
 * Example this section has some background before or style information You have
 * to write your own Renderer.
 * 
 * @see "highlightingNode"-method in KnowWE.js. There you can read how to use
 *      this renderer!
 * 
...
public class KDomSectionHighlightingRenderer extends KnowWEDomRenderer {
	...
	public static synchronized KDomSectionHighlightingRenderer getInstance() {
		if (instance == null) instance = new KDomSectionHighlightingRenderer();
		return instance;
	}

...
public class Priority implements Comparable<Priority> {
	...
	/**
	 * Returns the next higher Priority or null,
	 * if there is no higher Priority.
	 * 
	 * If this method returns null, you may simply need to add 
	 * a new higher Priority in this class.
	 */
	...
	/**
	 * Returns the next lower Priority or null
	 * if there is no lower Priority.
	 * 
	 * If this method returns null, you may simply need to add 
	 * a new lower Priority in this class.
	 */
	 ...
	 * a certain Priority. The Lists are mapped by this common Priority of the
	 * SubTreeHandlers.
	 * <p />
	 * The Sections in each List of the returned Map occur in the same order
	 * as they occur in the given List of Sections.
	 * <p />
	 ...
	 * @param sections
	 */
	public static TreeMap<Priority, List<Section<? extends KnowWEObjectType>>> 
			createPrioritySortedList(List<Section<? extends KnowWEObjectType>> sections) {

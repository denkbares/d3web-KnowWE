...
public class PropertyManager {
	...
	public boolean isValid(String property) {
		URI prop = UpperOntology.getInstance().getHelper().createlocalURI(
				property);
		return isValid(prop);
	}
	...
	public boolean isRDFS(URI property) {
		// TODO Auto-generated method stub
		return (property.getLocalName().contains("subClassOf")
				|| property.getLocalName().contains("type") || property
				.getLocalName().contains("subPropertyOf"));

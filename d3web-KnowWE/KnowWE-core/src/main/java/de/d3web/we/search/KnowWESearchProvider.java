...
/**
 * Interface for a KnowWE SearchProvider. To add another search-mechanism to KnowWE, 
...
public interface KnowWESearchProvider {
	...
	/**
	 * Core search method: returns a collection of GenericSearchResults for a given set of SearchTerms
	 * 
	 * @param words
	 * @param map
	 * @return
	...
	/**
	 * OPTIONAL: (may return null/empty string)
	 * Can be used to renderer the SearchResults in a specifc way
	 * 
	 * @param results
	 * @return
	 */
	 ...
	 * To provide a set of helpful terms (keywords?)
	 * 
	 * @return
	 */
	...
	/**
	 * OPTIONAL: (may return null/empty collection)
	 * Can add specific SearchTerms to be also recommended to the user, when SearchTerm t
	 * is searched. 
	 * 
	 * @param t
	 * @return
	 ...
	 * OPTIONAL: (may return null/empty collection)
	 * 
	 * can expand SearchTerm t (Query-Expansion - e.g., along taxonomic relations) 
	 * 
	 * @param t
	 * @return
	 */

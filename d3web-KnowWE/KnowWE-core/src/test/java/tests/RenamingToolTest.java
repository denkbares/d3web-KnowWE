...
public class RenamingToolTest extends TestCase {
	...
	public void testFindings() {
		...
		_env.processAndUpdateArticleJunit("TestUser", content1, "Test_Article1", "default_web", types);
		_env.processAndUpdateArticleJunit("TestUser", content2, "Test_Article2", "default_web", types);
		...
		Map<KnowWEArticle, Collection<WordBasedRenameFinding>> findings =
					KnowWEFacade.getInstance().renamingToolTest(map);

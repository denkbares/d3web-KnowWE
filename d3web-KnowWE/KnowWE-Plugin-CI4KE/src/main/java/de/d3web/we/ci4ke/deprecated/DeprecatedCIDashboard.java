...
@Deprecated
public class DeprecatedCIDashboard {
	
//	private static Logger log = Logger.getLogger(CIDashboard.class.getName());
	
//	private CIBuilder builder;
	
	private DeprecatedCIConfiguration config;

	private static final WikiEngine engine = 
		WikiEngine.getInstance(KnowWEEnvironment.getInstance().
	 ...
	 */
	public DeprecatedCIDashboard(Map<String, String> parameters, String dashboardArticleTitle){
		this.dashboardArticle = dashboardArticleTitle;
		

		this.config = new DeprecatedCIConfiguration(parameters, dashboardArticleTitle);

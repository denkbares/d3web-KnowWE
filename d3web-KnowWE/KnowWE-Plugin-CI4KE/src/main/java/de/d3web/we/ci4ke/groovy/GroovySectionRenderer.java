...
public class GroovySectionRenderer extends KnowWEDomRenderer<GroovyCITestType> {
	...
	public void render(KnowWEArticle article, Section<GroovyCITestType> sec,
		...
		KnowWERessourceLoader.getInstance().add("syntaxhighlighter_2.1.364/shCore.css", KnowWERessourceLoader.RESOURCE_STYLESHEET);
		KnowWERessourceLoader.getInstance().add("syntaxhighlighter_2.1.364/shThemeDefault.css", KnowWERessourceLoader.RESOURCE_STYLESHEET);

		KnowWERessourceLoader.getInstance().add("syntaxhighlighter_2.1.364/shCore.js", KnowWERessourceLoader.RESOURCE_SCRIPT);
		KnowWERessourceLoader.getInstance().add("syntaxhighlighter_2.1.364/shBrushGroovy.js", KnowWERessourceLoader.RESOURCE_SCRIPT);

...
//			">>> executeNewBuild angekommen! >>>");
	...
	/**
	 * Renders out the wiki changes (middle column) and the test results (right column)
	 * of a selected build
	 * @return
	 */
	public static String renderBuildDetails(String dashboardID, int selectedBuildNumber) {
		...
		//-------------------------------------------------------------------------		
		//At First: Render the wiki-changes in the middle column (ci-column-middle)
		//-------------------------------------------------------------------------
...
//				"Version " + articleVersionPrevious + ")</h4>");
		...
		//------------------------------------------------------------------------
		//At Second: Render the build details in the right colum (ci-column-right)
		//------------------------------------------------------------------------

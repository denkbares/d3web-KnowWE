...
public class DecisionTreeExportTest extends KnowledgeExporterTest {
	...
	public void testExampleFiles() {
		...
		String diagnosis = hc.readTxtFile("src" + File.separator + "doc" + File.separator
				+ "examples" + File.separator + "Baumerkennung" + File.separator
				+ "DiagnosisHierarchy.txt");
		String initQuestion = hc.readTxtFile("src" + File.separator + "doc" + File.separator
				+ "examples" + File.separator + "Baumerkennung" + File.separator
				+ "QuestionClassHierarchy.txt");
		String decisionTree = hc.readTxtFile("src" + File.separator + "doc" + File.separator
				+ "examples" + File.separator + "Baumerkennung" + File.separator
				+ "QuestionTree.txt");
	...
	// String diagnosis = hc.readTxtFile("src" + File.separator + "doc" +
	// File.separator + "examples" + File.separator + "Baumerkennung" +
	// File.separator + "DiagnosisHierarchy.txt");
	// String initQuestion = hc.readTxtFile("src" + File.separator + "doc" +
	// File.separator + "examples" + File.separator + "Baumerkennung" +
	// File.separator + "QuestionClassHierarchy.txt");
	// String decisionTree = hc.readTxtFile("src" + File.separator + "doc" +
	// File.separator + "examples" + File.separator + "Baumerkennung" +
	// File.separator + "QuestionTree.txt");
	//		
	// KnowledgeManager.setLocale(Locale.GERMAN);
	// setUpKB(diagnosis, initQuestion, decisionTree, null, null);
	// setUpTableWriter();
	// try {
	// tWriter.writeFile(new File("src" + File.separator + "doc" +
	// File.separator + "examples" + File.separator + "Baumerkennung" +
	// File.separator + "HeuristicDecisionTable.xls"));
	// } catch (IOException e) {
	// e.printStackTrace();
	// }
	// }

	// TODO: Mehr Tests zu Referenzen (siehe ExtDecisionTreeTest @
	// d3web-TextParser-Test)
	...
	public void testReferences() {
		...
		// assertEquals("Wrong export: ", hc.toString(decisionTreeFormatted),
		// writer.writeText());

...
// import
// de.d3web.kernel.psMethods.shared.comparators.num.QuestionComparatorNumFuzzy;
...
// this.createKB();
// this.setUptestParse("src" + File.separator + "doc" + File.separator +
// "examples" + File.separator + "decisionTable" + File.separator +
// "Aehnlichkeitstabelle.xls");
//		
// // Import
...
// File("exampleFiles\\decisionTable\\AehnlichkeitstabelleExport.xls"));
// // } catch (IOException e) {
// // // TODO Auto-generated catch block
// // e.printStackTrace();
// // }
// double minRes = 0.5;
// assertEquals("Unterschiede zwischen den Tabellen: ", "",
// hc.compareXLSTablesByRowContent(
// new File("src" + File.separator + "doc" + File.separator + "examples" +
// File.separator + "decisionTable" + File.separator +
// "Aehnlichkeitstabelle.xls"),
// new File("src" + File.separator + "doc" + File.separator + "examples" +
// File.separator + "decisionTable" + File.separator +
// "AehnlichkeitstabelleExport.xls"),
// minRes));
// assertEquals("Unterschiede zwischen den Tabellen: ", "",
// hc.compareXLSTablesByColumnContent(
// new File("src" + File.separator + "doc" + File.separator + "examples" +
// File.separator + "decisionTable" + File.separator +
// "Aehnlichkeitstabelle.xls"),
// new File("src" + File.separator + "doc" + File.separator + "examples" +
...
// // try {
// // writer.writeFile(new
// File("exampleFiles\\decisionTable\\AehnlichkeitstabelleDRExport.xls"));
// // } catch (IOException e) {
// // // TODO Auto-generated catch block
// // e.printStackTrace();
// // }
...
// new File("src" + File.separator + "doc" + File.separator + "examples" +
// File.separator + "decisionTable" + File.separator +
// "AehnlichkeitstabelleDRExport.xls"),
// minRes));
// assertEquals("Unterschiede zwischen den Tabellen: ", "",
// hc.compareXLSTablesByColumnContent(
// new File("src" + File.separator + "doc" + File.separator + "examples" +
...
// // try {
// // writer.writeFile(new
// File("exampleFiles\\decisionTable\\AehnlichkeitstabelleILExport.xls"));
// // } catch (IOException e) {
// // // TODO Auto-generated catch block
// // e.printStackTrace();
// // }
...
// new File("src" + File.separator + "doc" + File.separator + "examples" +
// File.separator + "decisionTable" + File.separator +
// "AehnlichkeitstabelleILExport.xls"),
// minRes));
// assertEquals("Unterschiede zwischen den Tabellen: ", "",
// hc.compareXLSTablesByColumnContent(
// new File("src" + File.separator + "doc" + File.separator + "examples" +
...
// // try {
// // writer.writeFile(new
// File("exampleFiles\\decisionTable\\AehnlichkeitstabellePExport.xls"));
// // } catch (IOException e) {
// // // TODO Auto-generated catch block
// // e.printStackTrace();
// // }
...
// new File("src" + File.separator + "doc" + File.separator + "examples" +
// File.separator + "decisionTable" + File.separator +
// "AehnlichkeitstabellePExport.xls"),
// minRes));
// assertEquals("Unterschiede zwischen den Tabellen: ", "",
// hc.compareXLSTablesByColumnContent(
// new File("src" + File.separator + "doc" + File.separator + "examples" +
...
// // try {
// // writer.writeFile(new
// File("exampleFiles\\decisionTable\\AehnlichkeitstabelleDExport.xls"));
// // } catch (IOException e) {
// // // TODO Auto-generated catch block
// // e.printStackTrace();
// // }
...
// new File("src" + File.separator + "doc" + File.separator + "examples" +
// File.separator + "decisionTable" + File.separator +
// "AehnlichkeitstabelleDExport.xls"),
// minRes));
// assertEquals("Unterschiede zwischen den Tabellen: ", "",
// hc.compareXLSTablesByColumnContent(
// new File("src" + File.separator + "doc" + File.separator + "examples" +
...
// // Import
// try{
// URL xlsFile = new File("src" + File.separator + "doc" + File.separator +
// "examples" + File.separator + "decisionTable" + File.separator +
// "AehnlichkeitstabelleW.xls").toURL();
...
// URL xlsFile = new File("src" + File.separator + "doc" + File.separator +
// "examples" + File.separator + "decisionTable" + File.separator +
// "AehnlichkeitstabelleWV.xls").toURL();
// KnowledgeBaseManagement kbm = KnowledgeBaseManagement.createInstance(kb);
// SyntaxChecker sChecker = new SimilarityTableSyntaxChecker();
// ValueChecker vChecker = new SimilarityTableValueChecker(kbm);
// KnowledgeGenerator knowGen = new SimilarityTableKnowledgeGenerator(kbm);
...
// xlsParser.insertKnowledge();
// } else {
// fail("beim Parsen ist ein Fehler aufgetreten: " +
// xlsParser.getReport().getErrorMsg());
// }

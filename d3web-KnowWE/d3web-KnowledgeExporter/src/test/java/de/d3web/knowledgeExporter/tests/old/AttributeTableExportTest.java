...
// String diagnosis = hc.readTxtFile(examplespath+ File.separator +
// "Baumerkennung" + File.separator + "DiagnosisHierarchy.txt");
// String initQuestion = hc.readTxtFile(examplespath+ File.separator +
// "Baumerkennung" + File.separator + "QuestionClassHierarchy.txt");
// String decisionTree = hc.readTxtFile(examplespath+ File.separator +
// "Baumerkennung" + File.separator + "QuestionTree.txt");
//		
// kb = hc.createKnowledgeBase(diagnosis, initQuestion,
// decisionTree).getKnowledgeBase();
//		
...
// try {
// url = new File(examplespath+ File.separator + "decisionTable" +
// File.separator + "config_AT.txt").toURL();
// attrReader = new AttributeConfigReader(url);
// url = new File(examplespath+ File.separator + "Baumerkennung" +
// File.separator + "Attributtabelle.xls").toURL();
...
// setUp();
// try {
// writer.writeFile(new File(examplespath + File.separator + "Baumerkennung" +
// File.separator + "AttributeTableExport.xls"));
// } catch (IOException e) {
// e.printStackTrace();
// }
// double minRes = 0.5;
...
// new File(examplespath + File.separator + "Baumerkennung" + File.separator +
// "Attributtabelle.xls"),
// new File(examplespath + File.separator + "Baumerkennung" + File.separator +
// "AttributeTableExport.xls"),
// minRes));
//
// }
//	

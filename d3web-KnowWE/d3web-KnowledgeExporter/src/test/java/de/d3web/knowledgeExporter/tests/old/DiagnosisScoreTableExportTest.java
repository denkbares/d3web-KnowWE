...
// File.separator + "diagnosescores.xls").toURL();
...
// File.separator + "DiagnosisScoreExport.xls"));
// } catch (IOException e) {
// e.printStackTrace();
// }
// double minRes = 0.8;

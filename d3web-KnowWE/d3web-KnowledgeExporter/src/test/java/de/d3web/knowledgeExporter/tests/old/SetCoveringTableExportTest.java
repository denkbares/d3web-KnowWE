...
//
//		
// String diagnosis = hc.readTxtFile(examplespath + File.separator + "xclTest" +
// File.separator + "Loesungen.txt");
// String initQuestion = hc.readTxtFile(examplespath+ File.separator + "xclTest"
// + File.separator + "Frageklassen.txt");
// String questions = hc.readTxtFile(examplespath + File.separator + "xclTest" +
// File.separator + "Fragebaum.txt");
// String xcl = hc.readTxtFile(examplespath + File.separator + "xclTest" +
// File.separator + "XCL.txt");
//		
//
// if (questions != null) {
// ressource = new TextParserResource(new
// ByteArrayInputStream(questions.getBytes()));
// input.put(KBTextInterpreter.QU_DEC_TREE, ressource);
// }
// if (diagnosis != null) {
// ressource = new TextParserResource(new
// ByteArrayInputStream(diagnosis.getBytes()));
// input.put(KBTextInterpreter.DH_HIERARCHY, ressource);
// }
// if (initQuestion != null) {
// ressource = new TextParserResource(new
// ByteArrayInputStream(initQuestion.getBytes()));
...
// try {
// tableWriter.writeFile(new File(examplespath + File.separator + "xclTest" +
// File.separator + "SetCoveringTable.xls"));
// } catch (IOException e) {
// e.printStackTrace();
// }
// }
...
// // new File("exampleFiles" + File.separator + "BaumwissensbasisCoveringLists"
// + File.separator + "Ueberdeckungstabelle.xls"),
// // new File("exampleFiles" + File.separator + "BaumwissensbasisCoveringLists"
// + File.separator + "UeberdeckungstabelleExport.xls"),
// // minRes));
// //
// // }
// //

...
//		
// String[] dTexts = {"diagnosisgroup 1", "group 1", "diagnosis 1",
// "diagnosis 2" };
//		
...
//		
// String[] dTexts = {"diagnosisgroup 1", "group 1", "diägnosis 1",
// "diagnosis 2" };
//		
// String expectedExport = dTexts[0] + " #0\n"
// + "- " + dTexts[1] + " #1\n"
...
// // setUpKB(diagnosis);
// //
// // assertEquals("Diagnosis has the wrong value: ", "P000",
// kb.getDiagnoses().get(0).getText());
// // assertEquals("Diagnosis has the wrong value: ", "diagnosisgroup 1",
// kb.getDiagnoses().get(1).getText());
// // assertEquals("Diagnosis has the wrong value: ", "group 1",
// kb.getDiagnoses().get(2).getText());
// // assertEquals("Diagnosis has the wrong value: ", "diagnosis 1.1",
// kb.getDiagnoses().get(3).getText());
// // assertEquals("Diagnosis has the wrong value: ", "diagnosis 1.2",
// kb.getDiagnoses().get(4).getText());
// // assertEquals("Diagnosis has the wrong value: ", "group 2",
// kb.getDiagnoses().get(5).getText());
// // assertEquals("Diagnosis has the wrong value: ", "diagnosis 2.1",
// kb.getDiagnoses().get(6).getText());
// // assertEquals("Diagnosis has the wrong value: ", "diagnosisgroup 2",
// kb.getDiagnoses().get(7).getText());
// // assertEquals("Diagnosis has the wrong value: ", "group 3",
// kb.getDiagnoses().get(8).getText());
// // assertEquals("Diagnosis has the wrong value: ", "diagnosis 3.1",
// kb.getDiagnoses().get(9).getText());
// // }
// //
// //
// // @Test
...
// //
// // // check diagnosis#
// // assertEquals("Incorrect number of diagnosis found!", 10,
// kb.getDiagnoses().size());
// //
// // // check root node
// // assertEquals("Diagnosis hierarchy has wrong root node: ", "P000",
// kb.getRootDiagnosis().getText());
// // assertEquals("Root node has wrong number of children: ", 2,
// kb.getRootDiagnosis().getChildren().size());
// // assertEquals("Root node has father: ", 0,
// kb.getRootDiagnosis().getParents().size());
// //
// // // check children#
...
// // assertTrue("Wrong objecttype found!",
// checkInstanceOf(kb.getDiagnoses().get(i)));
// // }
// // // check parent#
...
// // assertNotNull("Caution! No beginning question available.",
// kb.getInitQuestions());
// // }
// }

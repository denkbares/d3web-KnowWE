...
//
//public abstract class AbstractQuestionBlockSheetRenderer extends AbstractFormatableSheetRenderer {
//	
...
//
//
//	public AbstractQuestionBlockSheetRenderer(KnowledgeBase kb, HSSFSheet sheet, Collection rules,KnowledgeManager m) {
//		super(kb, sheet,m);
//		this.rules = rules;
//		
//		

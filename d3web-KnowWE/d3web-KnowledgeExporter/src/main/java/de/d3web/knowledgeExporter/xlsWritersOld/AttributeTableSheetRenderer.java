...
// *
// */
//public class AttributeTableSheetRenderer extends AbstractFormatableSheetRenderer {
//
//	private static final String WEIGHT = "PSMethodShared:SHARED_WEIGHT";
//
//	private static final String LOCAL_WEIGHT = "PSMethodShared:SHARED_LOCAL_WEIGHT";
//
//	private static final String ABNORMALITY = "PSMethodShared:SHARED_ABNORMALITY";
//
...
//
//			rowCnt++;
//			setCellValue(0, qRow.getRowNum(), element.toString(),AbstractFormatableSheetRenderer.STYLE_BOLD);
//			

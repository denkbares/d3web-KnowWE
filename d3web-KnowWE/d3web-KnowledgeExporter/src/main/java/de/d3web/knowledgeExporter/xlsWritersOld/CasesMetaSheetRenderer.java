...
//
// public CasesMetaSheetRenderer(KnowledgeBase kb, HSSFSheet s, KnowledgeManager
// m, Iterable<CaseObject> cases) {
// super(kb, s, m);
// this.cases = cases;
...
//			
// //TITLE
// setCellValue(column++, row, markup.getContent(DCElement.TITLE),
// STYLE_SMALLBOLD);
//			
// //rest of DC
...
// //if (d == null) d = new Date(); <-- TODO: so machen wie
// Plugin-CaseManagement?
...
// setCellValue(column++, row,
// resourceBundle.getString("d3web.KnowME.CaseManagement.MetaInfo."+
...
//		
// //DC
// setCellValue(column++, 0,
// resourceBundle.getString("d3web.KnowME.CaseManagement.MetaInfo.id"),
// STYLE_SMALLBOLD);
// setCellValue(column++, 0,
// resourceBundle.getString("d3web.KnowME.CaseManagement.MetaInfo.author"),
// STYLE_SMALLBOLD);
// setCellValue(column++, 0,
// resourceBundle.getString("d3web.KnowME.CaseManagement.MetaInfo.date"),
// STYLE_SMALLBOLD);
// setCellValue(column++, 0,
// resourceBundle.getString("d3web.KnowME.CaseManagement.MetaInfo.subject"),
// STYLE_SMALLBOLD);
// setCellValue(column++, 0,
// resourceBundle.getString("d3web.KnowME.CaseManagement.MetaInfo.publisher"),
// STYLE_SMALLBOLD);
// setCellValue(column++, 0,
// resourceBundle.getString("d3web.KnowME.CaseManagement.MetaInfo.contributor"),
// STYLE_SMALLBOLD);
// setCellValue(column++, 0,
// resourceBundle.getString("d3web.KnowME.CaseManagement.MetaInfo.source"),
// STYLE_SMALLBOLD);
// setCellValue(column++, 0,
// resourceBundle.getString("d3web.KnowME.CaseManagement.MetaInfo.language"),
// STYLE_SMALLBOLD);
//		
// //OTHER
// setCellValue(column++, 0,
// resourceBundle.getString("d3web.KnowME.CaseManagement.MetaInfo.description"),
// STYLE_SMALLBOLD);
// setCellValue(column++, 0,
// resourceBundle.getString("d3web.KnowME.CaseManagement.MetaInfo.complex"),
// STYLE_SMALLBOLD);
// setCellValue(column++, 0,
// resourceBundle.getString("d3web.KnowME.CaseManagement.MetaInfo.workingTime"),
// STYLE_SMALLBOLD);
// }
// }

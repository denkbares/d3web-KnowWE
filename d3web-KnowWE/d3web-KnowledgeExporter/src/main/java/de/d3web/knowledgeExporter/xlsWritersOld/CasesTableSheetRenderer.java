...
//
//	public CasesTableSheetRenderer(KnowledgeBase kb, HSSFSheet s, KnowledgeManager m,
//			Iterable<CaseObject> cases, boolean renderAnswers, boolean renderDiagnoses, boolean splitMCQs) {
//		super(kb, s, m);
//		
//		this.cases = cases;
...
//								setCellValue(column + answerToNumber.get(answer), row, manager.getResourceBundle()
...
//		
//		for (CaseObject co : cases) {
//			setCellValue(0, row++, co.getDCMarkup().getContent(DCElement.TITLE), STYLE_SMALLBOLD);
//		}
//	}
//

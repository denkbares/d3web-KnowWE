...
//				&& isMaxDepth(cond, 2) && r.getException() == null && r.getContext() == null && (!(cond instanceof TerminalCondition)) && r.getException() == null && r.getContext() == null) {
//	
...
//				// Regeln mit Konditionen der Form NICHT(ODER(....))/ NICHT(UND(...))dürfen nicht in die Tabelle
...
//			new DecisionTableSheetRenderer(kb, sheet, part, manager).renderSheetFormated();
//		}
//
//		HSSFSheet sheet = wb.createSheet();
//		sheet.setDefaultColumnWidth((short) 20);

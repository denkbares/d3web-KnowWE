...
// import
// de.d3web.kernel.psMethods.shared.comparators.GroupedComparatorAsymmetric;
// import
// de.d3web.kernel.psMethods.shared.comparators.GroupedComparatorSymmetric;
...
// import
// de.d3web.kernel.psMethods.shared.comparators.num.QuestionComparatorNumDivision;
// import
// de.d3web.kernel.psMethods.shared.comparators.num.QuestionComparatorNumDivisionDenominator;
// import
// de.d3web.kernel.psMethods.shared.comparators.num.QuestionComparatorNumIndividual;
// import
// de.d3web.kernel.psMethods.shared.comparators.num.QuestionComparatorNumSection;
// import
// de.d3web.kernel.psMethods.shared.comparators.num.QuestionComparatorNumSectionInterpolate;
// import
// de.d3web.kernel.psMethods.shared.comparators.oc.QuestionComparatorOCScaled;
...
// if ((i != j) && (comp instanceof GroupedComparatorAsymmetric || (comp
// instanceof GroupedComparatorSymmetric && j < i))) {
...
// found = true;
// setCellValue(1, elementRow,
// "Abschnitt normal",AbstractFormatableSheetRenderer.STYLE_BOLD);
...
// .hasNext();) {
// Object value = (Object) iterator.next();
// setCellValue(1, elementRow+counter+2,
// value.toString(),AbstractFormatableSheetRenderer.STYLE_BOLD);
//							
//							
// }
// }
...
// found = true;
// QuestionComparatorNumSectionInterpolate c =
// ((QuestionComparatorNumSectionInterpolate)comp);
// List values = c.getValues();
// setCellValue(1, elementRow,
// "Abschnittsweise interpoliert",AbstractFormatableSheetRenderer.STYLE_BOLD);
//						
// int counter = 0;
// for (Iterator iterator = values.iterator(); iterator
// .hasNext();) {
...
// found = true;
// QuestionComparatorNumDivisionDenominator c =
// ((QuestionComparatorNumDivisionDenominator)comp);

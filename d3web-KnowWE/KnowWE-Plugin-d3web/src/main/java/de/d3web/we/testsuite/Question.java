...
public class Question extends DefaultAbstractKnowWEObjectType {
	
	@Override
	public void init() {
		this.sectionFinder = new QuestionSectionFinder();
	}
	
	@Override
	public KnowWEDomRenderer getRenderer() {
		return new ObjectInfoLinkRenderer(FontColorRenderer.getRenderer(FontColorRenderer.COLOR6));
	}

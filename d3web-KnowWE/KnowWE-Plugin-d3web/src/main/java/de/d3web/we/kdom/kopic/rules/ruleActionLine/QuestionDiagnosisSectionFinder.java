 ...
 *
 * Finds Question or Diagnosis in RuleActionLine.
 */
public class QuestionDiagnosisSectionFinder extends SectionFinder {
	...
	public List<SectionFinderResult> lookForSections(String text, Section father) {
		...
		if (!text.equals("")) {
			...
			String copytext = text.trim();
			end = copytext.length() + 1;
			...
			// Remove Quotes
			if (copytext.startsWith("\"") && copytext.endsWith("\"")) {
				start++;
				end--;
			}

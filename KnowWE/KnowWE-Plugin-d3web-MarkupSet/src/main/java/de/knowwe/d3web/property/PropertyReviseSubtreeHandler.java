...
public class PropertyReviseSubtreeHandler extends D3webSubtreeHandler<PropertyType> {
	...
	public Collection<KDOMReportMessage> create(KnowWEArticle article, Section<PropertyType> s) {
		Section<IDObjectReference> idobjectSection =  Sections.findSuccessor(s, IDObjectReference.class);
		Section<PropertyReference> propertySection =  Sections.findSuccessor(s, PropertyReference.class);

...
Timeline.SpanHighlightDecorator = function(params) {
    ...
    this._unit = params.unit != null ? params.unit : Timeline.NativeDateUnit;
...
Timeline.SpanHighlightDecorator.prototype.paint = function() {
    ...
    if (this._unit.compare(this._startDate, maxDate) < 0 &&
        ...
        tdStart.appendChild(doc.createTextNode(this._startLabel));
        if (this._cssClass) {
        ...
        tdEnd.appendChild(doc.createTextNode(this._endLabel));
        if (this._cssClass) {

/* Generated By:JJTree&JavaCC: Do not edit this line. QueryLangTokenManager.java */
package de.knowwe.timeline.parser;
import de.knowwe.timeline.tree.*;
import de.knowwe.timeline.Timeset;

/** Token Manager. */
public class QueryLangTokenManager implements QueryLangConstants
{
...
"\76", "\74", "\75", "\76\75", "\74\75", null, "\50", "\51", null, null, null, null, 
...
/** Constructor. */
public QueryLangTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public QueryLangTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}

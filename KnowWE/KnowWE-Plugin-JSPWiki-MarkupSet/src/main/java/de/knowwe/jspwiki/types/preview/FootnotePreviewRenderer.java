...
/**
 * Renders the preview of a footnote.
 * 
 * @author Volker Belli (denkbares GmbH)
 * @created 21.02.2014
 */
public class FootnotePreviewRenderer extends AbstractPreviewRenderer {

	@Override
	public void render(Section<?> section, Collection<Section<?>> relevantSubSections, UserContext user, RenderResult result) {
		Section<FootnoteType> footnote = Sections.cast(section, FootnoteType.class);
		result.append(footnote.getText());
	}
}

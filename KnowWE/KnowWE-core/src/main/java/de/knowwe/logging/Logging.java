...
public class Logging {
	...
	/**
	 * !!!!!!! Way better than the simple log method !!!!!! Logs the correct
	 * class and method. gets the Logger of the specified class, logs a message
	 * with the specified level and an optional user or plugin. If user is null,
	 * only the message and the plugin will be logged, if plugin is null only
	 * the message and the user will be logged. If both are null only the
	...
	/**
	 * adds a FileHandler with an output file named filename and a
	 * consoleHandler with Level.SEVERE to the Logger log. Also disables
	 * parenthandlers.
	 */

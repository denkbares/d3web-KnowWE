...
public class TurtleObjectBlankNode extends AbstractType {
	...
	public TurtleObjectBlankNode() {
		...
		// GenericHTMLRenderer<TurtleObjectBlankNode>("span", new String[]
		// {"style", "color: pink;", "title", "TurtleObjectBlankNode"}));
	}

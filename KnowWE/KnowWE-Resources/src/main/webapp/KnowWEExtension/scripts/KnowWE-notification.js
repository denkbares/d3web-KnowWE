...
KNOWWE.notification = function() {
	...
	return { 
		...
		_select : function(index) {
			...
			jq$('#KnowWENotificationQuit').html(
					'<span><a href="#" onclick="javascript:KNOWWE.notification.removeNotification(\'' + message.id + '\')'
							+ '">X</a></span>');
 ...
 (function init() {
 	if (KNOWWE.helper.loadCheck([ 'Wiki.jsp' ])) {
 		window.addEvent('domready', function() {
 			...
 			KNOWWE.helper.observer.subscribe('update', KNOWWE.notification.loadNotifications);
 		});
 	}
 }());

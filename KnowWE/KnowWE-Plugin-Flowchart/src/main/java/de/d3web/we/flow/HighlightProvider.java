...
public class HighlightProvider implements ToolProvider {
	...
	protected Tool getHighlightTool(KnowWEArticle article, Section<?> section, KnowWEUserContext userContext) {
		String highlight = userContext.getUrlParameterMap().get("highlight");

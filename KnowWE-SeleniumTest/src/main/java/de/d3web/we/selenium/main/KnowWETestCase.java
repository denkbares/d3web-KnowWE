...
public abstract class KnowWETestCase extends KnowWESeleneseTestCase {
	...
	/**
	 * The KnowWE-Selenium-Test ResourceBundle, containing specific
	 * information being needed for the tests (e.g. sleepTime, server
	 * url, ...)
	 */
	...
	/**
	 * If this time duration is expired, the page load will be canceled and
	 * the test fails with a TimedOut Exception.
	 */
	...
	/**
	 * This is a little help method if you want to access any element with
	 * a Selenium method on its xpath locator. It's kind of a upgrade of the
	 ...
	 * @return True if the element was found in the specified period, else false.
	 */
	 ...
	 * method which is not specified in doSelActionAndWait, this Exception
	 * is thrown.
	 * @author Max Diez
	 * 
	 */

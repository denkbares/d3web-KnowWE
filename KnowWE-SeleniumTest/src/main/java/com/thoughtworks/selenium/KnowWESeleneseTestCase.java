 ...
 */
public class KnowWESeleneseTestCase extends TestCase {

    private KnowWESeleneseTestBase stb = new KnowWESeleneseTestBase();
    
    /** Use this object to run all of your selenium tests */
    protected Selenium selenium;
    
    public KnowWESeleneseTestCase() {
        super();
    }

    
    public KnowWESeleneseTestCase(String name) {
        super(name);
    }
	...
	/**
	 * Sets up the SeleneseTestBase, allowing to set a RC server address and port.
    ...
    public void setUp(String url, String browserString, String server, int port) {
        stb.setUp(url, browserString, server, port);
        selenium = stb.selenium;
    }    
    ...
    public static void assertEquals(Object s1, Object s2) {
        KnowWESeleneseTestBase.assertEquals(s1, s2);
    }
    ...
    public static void assertNotEquals(boolean b1, boolean b2) {
    	KnowWESeleneseTestBase.assertNotEquals(b1, b2);
    }
    
    /** Asserts that two objects are not the same (compares using .equals()) */
    public static void assertNotEquals(Object obj1, Object obj2) {
    	KnowWESeleneseTestBase.assertNotEquals(obj1, obj2);
    }
    ...
    public static boolean seleniumEquals(Object expected, Object actual) {
        return KnowWESeleneseTestBase.seleniumEquals(expected, actual);
    }

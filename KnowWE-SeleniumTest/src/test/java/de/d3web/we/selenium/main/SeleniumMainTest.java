 ...
 * get Selenium-grid and update it's local path in StartClients.bat. Because
 * Selenium is a browser based test, some clients are started with
 * StartClients.bat and closed after the test with KillClients.bat. Test: First
 * the needed pages are set up and afterwards the tests will be run in PARALLEL.
 * 
 * @author Max Diez
 * 
 */
public class SeleniumMainTest extends TestSuite {
	...
	/**
	 * Add to mainSuite in the right order the tests which have to be run in
	 * serial or are needed as startup for the other tests. Afterwards the
	 * independent test units are added in a ParallelTestSuite
	 * 
	...
	public static TestSuite suite() throws Exception {
		...
		// TestSuite parallelSuite = new
		// ParallelTestSuite("Testsuite for all parallel units");
